...
def evaluate(config,
    ...
    query_features, query_labels = predict(config, model, query_dataloader)  # baseline

    print("Compute Scores:")



    r = calculate_scores(query_features, reference_features, query_labels, reference_labels,
...
def calc_sim(config,
    ...
    r1 = calculate_scores(query_features, reference_features, query_labels, reference_labels,
                          step_size=step_size, ranks=ranks)[0]
...
def calculate_nearest(query_features, reference_features, query_labels, reference_labels,
