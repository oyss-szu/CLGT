...
class VigorDatasetTrain(Dataset):
    ...
    def __init__(self,
        ...
        self.transforms_reference_bev = transforms_reference_bev  # bev
    ...
    def __getitem__(self, index):
        ...
        # bev transform
        bev_img = get_BEV_tensor(query_img, 384, 384, Fov=85 * 2, dty=0,
                                   dx=0, dy=0, out=None, device='cpu')

        groundA_img = cv2.imread(self.idx2ground_path[idx_ground])
        ...
        #     add_noise_to_tensor(ground_img_bev)
        ...
        # print(f"ground_img: {query_img.shape}, sat_img: {reference_img.shape}, bev: {ground_img_bev.shape}")



        # return query_img, reference_img, ground_img_bev, label,q_gps,r_gps
...
class VigorDatasetEval(Dataset):
    ...
    def __init__(self,
        ...
        if self.img_type == "reference":
            ...
            # visualize_transformed_images(self.bev_images, transforms_reference_bev)
