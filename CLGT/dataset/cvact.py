...
# Using online generation of BEV leads to unstable training;
# therefore, we recommend employing BEV.py to generate BEV offline for training, with cvact_offline.py provided as an example of the offline version.
class CVACTDatasetTrainOurs(Dataset):
    ...
    def __init__(self,
        ...
        for idx in train_ids.squeeze():
            ...
            # grd_path = f'ANU_DATA_SMALL/ANU_data_small/streetview/{idx}_grdView.jpg'
            # sat_path = f'ANU_DATA_SMALL/ANU_data_small/satview_polish/{idx}_satView_polish.jpg'
    ...
    def __getitem__(self, index):
        ...
        # ground_img = cv2.imread(f'{self.data_folder}/ANU_DATA_SMALL/ANU_data_small/streetview/{idx}_grdView.jpg')
        ground_img = cv2.cvtColor(ground_img, cv2.COLOR_BGR2RGB)

        # groundA_img = cv2.imread(f'{self.data_folder}/ANU_DATA_SMALL/ANU_data_small/streetview/{idx}_grdView.jpg')
        ...
        # bev transform
        bev_img = get_BEV_tensor(ground_img, 384, 384, Fov=85 * 2, dty=0,
                                   dx=0, dy=0, out=None, device='cpu')

        # load reference -> satellite image
        # sat_img = cv2.imread(f'{self.data_folder}/ANU_DATA_SMALL/ANU_data_small/satview_polish/{idx}_satView_polish.jpg')
        ...
        if np.random.random() < self.prob_rotate:
            ...
            shifts = - w // 4 * r
            # ground_img_bev = torch.roll(ground_img_bev, shifts=shifts, dims=2)
...
class CVACTDatasetEval(Dataset):
    ...
    def __init__(self,
        ...
        for idx in ids.squeeze():
            ...
            # grd_path = f'{self.data_folder}/ANU_DATA_SMALL/ANU_data_small/streetview/{idx}_grdView.jpg'
    ...
    def __getitem__(self, index):
        ...
        if self.img_type == "reference":
            ...
            # path = f'{self.data_folder}/ANU_DATA_SMALL/ANU_data_small/streetview/{idx}_grdView.jpg'
...
class CVACTDatasetTest(Dataset):
    ...
    def __init__(self,
        ...
        # files_ground = glob(f'{self.data_folder}/ANU_DATA_TEST/ANU_data_test/streetview/*_grdView.jpg')
        # files_ground = glob(f'../dataset/ECCV-ZhangQingQang/CVACT_val-C-ALL/*_grdView.jpg')
