...
df_train = pd.read_csv('/data/wule/database/CVUSA/splits/train-19zl.csv', header=None)
...
df_gps = pd.read_csv('/data/wule/database/CVUSA/splits/all.csv', header=None)
...
print("Saving...") 
with open("../dataset/gps_dict.pkl", "wb") as f:
