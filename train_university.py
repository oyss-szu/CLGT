...
from ours.dataset.university import U1652DatasetEval, U1652DatasetTrain, get_transforms
from ours.utils import setup_system, Logger
from ours.trainer import train_ours
from ours.evaluate.university import evaluate
from ours.loss import InfoNCE
from ours.model import TimmModel_Ours
...
class Configuration:
    ...
    data_folder: str = "./data/wule/database/University"
...
if config.dataset == 'U1652-D2S':
    config.query_folder_train = './data/wule/database/University/train/satellite'
    config.gallery_folder_train = './data/wule/database/University/train/drone'   
    config.query_folder_test = './data/wule/database/University/test/query_drone' 
    config.gallery_folder_test = './data/wule/database/University/test/gallery_satellite'    
elif config.dataset == 'U1652-S2D':
    config.query_folder_train = './data/wule/database/University/train/satellite'
    config.gallery_folder_train = './data/wule/database/University/train/drone'    
    config.query_folder_test = './data/wule/database/University/test/query_satellite'
    config.gallery_folder_test = './data/wule/database/University/test/gallery_drone'
